...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%	List<Restaurant> list = (List) request.getAttribute("restaurantList"); %>
...
<form action="./search" method="post" id=reset_form>
<div id="search">
...
<br>
 ...
 <input type="radio" name="cat" value="301">한식  </label>
  <label class="btn btn-info btn-xs">
 <input type="radio" name="cat" value="302">양식</label>
  <label class="btn btn-info btn-xs">
 <input type="radio" name="cat" value="303">중식</label>
  <label class="btn btn-info btn-xs">
<input type="radio" name="cat" value="304">일식</label>
 <label class="btn btn-info btn-xs">
<input type="radio" name="cat" value="305">아시아 음식</label>
 <label class="btn btn-info btn-xs">
<input type="radio" name="cat" value="306">카페</label>
 <label class="btn btn-info btn-xs">
<input type="radio" name="cat" value="307">분식</label>
 <label class="btn btn-info btn-xs">
<input type="radio" name="cat" value="308">기타</label>
 </div>
...
<button type="button" id="btn_reset" class="btn btn-success btn-sm" >검색 초기화</button>
 ...
 <button type="submit" class="btn btn-warning btn-sm" onclick='location.href="/restaurant/search";'>검색</button>
...
<br>
<br>
</form><!-- 잘 있네요 div 안에...ㅎㅎ;;제가 위치를 잘못 잡았나봐요 그러면... 되는군요... 한번도 이렇게는 안해봐서 몰랐어요 그럼 다른 오류인가보네요 -->

</div>

<div id="list" style="overflow-y: scroll;">
<div id="qwer" style="width:100%; height:400px;">
<table class="table table-striped table-hover table-condensed" >
<tr>
	<th style="width:7%;"></th>
	<th  style="width:10%;">가게명</th>
	<th  style="width:10%;">번호</th>
	<th style="width:28%;">정보</th>
	
</tr>
<%	for(int i=0; i<list.size(); i++) { %>
<tr>
	
	<td><li><img src="/resources/img/main.png" width="70px;"/></li></td>
	<td>
		<a href="/restaurant/detail?resno=<%=list.get(i).getResNo() %>">
		<%=list.get(i).getResName() %>
		</a></td>
	<td><%=list.get(i).getResPhone() %><br></td>
	<td><%=list.get(i).getResTime()%><br>
	<%=list.get(i).getResRoad() %></td>
</tr>
<%	} %>
</table>
</div>
