     			...
     			<div class="col-md-12">
     				<div class="card">
		                ...
		                <table class="table table-bordered table-hover dataTable dtr-inline" id="dataTable">
		                  ...
		                  <tbody>
		                    ...
		                    <tr>
		                    	...
		                    	<td>
		                    		<a href="/admin/notice/view?boardno=<%=list.get(i).getBoardNo() %>">
		                    	...
		                    	<td>
		                    		<button type="button" class="btn btn-outline-danger btn_del" onclick="location.href='/admin/notice/delete?boardno=<%=list.get(i).getBoardNo() %>'">삭제</button>
		                    	</td>
		                    	<%} %>
		                    </tr>
		              ...
		              <div class="card-footer">
		                  <button type="button" class="btn btn-info" onclick="location.href='/admin/notice/write'">등록</button>
	                  </div>
		            </div>
     			</div>
     		</div>
