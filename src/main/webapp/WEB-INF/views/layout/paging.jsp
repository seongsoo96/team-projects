...
<div class="paging text-center">
	<ul class="pagination">
		...
		<%-- 첫 페이지면 금지 표시 --%>
		<c:if test="${paging.curPage ne 1 }">
		   <li><a href="${contextPath}?curPage=${paging.curPage-1 }${categoryParam}${searchParam}">&laquo;</a></li>
		</c:if>
		...
		<c:if test="${paging.curPage ne paging.totalPage }">
			<li><a href="${contextPath}?curPage=${paging.curPage+1 }${categoryParam}${searchParam }"><span>&raquo;</span></a></li>
		</c:if>
