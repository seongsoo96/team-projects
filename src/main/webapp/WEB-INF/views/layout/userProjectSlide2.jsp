		...
		<c:when test="${project.pState ne 'Y' }">
			<nav class="menuContainer">
				<ul id="temp">		
					...
					<li><a href="/user/maker/project/view?pNo=${project.pNo}" id="project" class="side_link background">펀딩준비</a></li>
...
<!-- 			<a href="#" id="funding" class="side_link">펀딩현황&nbsp;<i class="fas fa-lock"></i></a> -->
		...
		<c:otherwise>
			<nav class="menuContainer">
				<ul>
					<li><h4>${name }의<br>프로젝트 번호:${project.pNo}</h4></li>
					<li><a href="/user/maker/project/view?pNo=${project.pNo}" id="project" class="side_link">펀딩준비</a></li>
					<li><a href="/user/maker/news/list?pNo=${project.pNo}" id="news" class="side_link">새소식&nbsp;<i class="fas fa-lock-open"></i></a></li>
					<li><a href="/user/maker/open/requirement?pNo=${project.pNo}" id="open" class="side_link">오픈예정&nbsp;<i class="fas fa-lock-open"></i></a></li>
					<li><a href="/user/maker/supporter/list?pNo=${project.pNo}" id="supporter" class="side_link">서포터&nbsp;<i class="fas fa-lock-open"></i></a></li>
					<li><a href="/user/maker/funding/view?pNo=${project.pNo}" id="funding" class="side_link">펀딩현황&nbsp;<i class="fas fa-lock-open"></i></a></li>
				</ul>
			</nav>
