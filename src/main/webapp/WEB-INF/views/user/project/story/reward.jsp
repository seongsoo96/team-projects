		...
		<form role="role">
			...
			<c:forEach items="${rewardList }" var="reward">
				<div class="rewardItem">
					...
					<textarea style="text-align:left; font-weight: lighter; width:210px; height:60px;" readonly>${reward.reContext }</textarea>
					<p style="text-align:left;">옵션: ${reward.reOption }</p>
					<textarea style="text-align:left; font-weight: lighter; width:210px; height:60px;" readonly>${reward.reOptionContext }</textarea>
