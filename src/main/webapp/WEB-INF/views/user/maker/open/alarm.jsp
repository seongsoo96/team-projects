...
<c:forEach items="${list }" var="alarm">
	<tr>
		<td style="text-align:center;">${alarm.A_NO }</td>
		<td style="text-align:center;">${alarm.M_ID }</td>
		<td style="text-align:center;">${alarm.M_NICK }</td>
		<td style="text-align:center;"><fmt:formatDate value="${alarm.A_CREATE_DATE }" pattern="yy-MM-dd" /></td>
	</tr>
</c:forEach>
</tbody>
</table>
