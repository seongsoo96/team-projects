...
<div id="pagination-wrap2">
		<ul>
			<a href="/user/maker/open/requirement?pNo=${project.pNo }"><li id="requirement"></li></a>
			<a href="/user/maker/open/information?pNo=${project.pNo }"><li id="information"></li></a>
			<a href="/user/maker/open/story?pNo=${project.pNo }"><li id="story"></li></a>
			<a href="/user/maker/open/reward?pNo=${project.pNo }"><li id="reward"></li></a>
			<a href="/user/maker/open/maker?pNo=${project.pNo }"><li id="maker"></li></a>
			<a href="/user/maker/open/alarm?pNo=${project.pNo }"><li id="alarm"></li></a>
	     </ul>
</div>