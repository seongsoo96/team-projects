...
<div id="content">
	...
	<div class="container">
		...
		<form action="/user/maker/news/modify" method="post" role="role" enctype="multipart/form-data">
			...
			<div class="background-white form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        ...
                        <button type="button" class="btn btn-info" onclick="location.href='/user/maker/news/view?nNo=${news.nNo }'">돌아가기</button>
                    </div>
            </div>
		</form>
	</div>
