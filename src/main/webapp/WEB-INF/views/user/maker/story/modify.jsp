...
<div id="content">
	...
	<div class="container">
		...
		<form action="/user/maker/story/modify" method="post" role="role" enctype="multipart/form-data">
			...
			<div class="background-white form-group alert" role="alert">
				...
				<textarea id="sSummery" name="sSummery" class="form-control" rows="3" required="required">${story.sSummery }</textarea>
			</div>
