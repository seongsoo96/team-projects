package ppeonfun.controller.admin.news;
...
import ppeonfun.service.admin.news.NewsService;
...
public class NewsController {
	...
	public void list(Paging inData, Model model, Project project) {
		logger.info("/admin/news/list 실행");
	...
	public void write(Project project, Model model) {
		logger.info("/admin/news/write [GET]실행");
	...
	public String write(News news, MultipartHttpServletRequest mtfRequest) {
		logger.info("/admin/news/write [POST]");
