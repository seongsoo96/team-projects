package ppeonfun.controller.admin.open;
...
import ppeonfun.service.admin.open.OpenService;
import ppeonfun.util.Paging;

@Controller("admin.OpenController")
...
public class OpenController {
	...
	public void requirement(Project project, Model model) {
		logger.info("/admin/open/requirement ");
	...
	public void information(Project project, Model model) {
		logger.info("/admin/open/information ");
