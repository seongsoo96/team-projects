...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%	List<Restaurant> list = (List) request.getAttribute("restaurantList"); %>
    <% List<Restaurantimg> resimgList = (List) request.getAttribute("Restaurantimg");%>
     			...
     			<div class="col-md-12">
     				<div class="card">
		              <div class="card-header">
		                <h3 class="card-title">전체 맛집 조회</h3>		
		              </div>
		              <!-- /.card-header -->
		                ...
		                <table class="table table-bordered table-hover dataTable dtr-inline" id="dataTable">
		                  <thead>
		                    ...
		                    <th style="width:10%">No.</th>
		                      <th class="sorting_asc_disabled sorting_desc_disabled">가게명</th>
		                      <th class="sorting_asc_disabled sorting_desc_disabled">번호</th>
		                      <th class="sorting_asc_disabled sorting_desc_disabled">정보</th>
		                      <th class="sorting_asc_disabled sorting_desc_disabled">주소</th>
		                  ...
		                  <tbody>
		                    ...
		                    <tr > 
		                    	...
		                    	<td><%=list.get(i).getResPhone() %></td>
		                    	<td><%=list.get(i).getResParking() %></td>
		                    	<td><%=list.get(i).getResRoad() %></td> 
		                    	<td>
                   				<button type="button" class="btn btn-outline-danger btn_del" onclick="location.href='/admin/restaurantdelete?resno=<%=list.get(i).getResNo() %>'">삭제</button>
		                    	</td>
		                    </tr>
		                    <%} %>
		                  </tbody>
		              ...
		              <div class="card-footer">
		                  ...
		                  <button type="button" class="btn btn-info" onclick='location.href="/admin/restaurantwrite";'>등록</button>
