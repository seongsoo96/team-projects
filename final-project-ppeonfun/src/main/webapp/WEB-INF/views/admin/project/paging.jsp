...
<%-- 		</c:if> --%>
		...
		<c:choose>
			<c:when test="${paging.startPage gt paging.pageCount }">
				...
				<a href="?curPage=${paging.startPage - paging.pageCount }${categoryParam}${searchParam}"
		...
		<c:forEach var="i" begin="${paging.startPage }" end="${paging.endPage }" step="1">
			<c:choose>
				<c:when test="${i eq paging.curPage }">
					<li><a href="?curPage=${i }${categoryParam}${searchParam}"
...
<%-- 		</c:if> --%>
		...
		<c:choose>
			<c:when test="${paging.endPage ne paging.totalPage }">
				<li><a href="?curPage=${paging.startPage + paging.pageCount }${categoryParam}${searchParam}"
