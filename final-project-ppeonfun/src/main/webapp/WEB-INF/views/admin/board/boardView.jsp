...
function refreshList(b_no, array){
	$.ajax({
		type: "GET"
		, url: "/admin/board/comments/refresh"
		, data: {
			bNo: b_no
			, standard: array
		}
...
function CmtUpdateForm(c_no, b_no){
	$.ajax({
		type: "GET"
		, url: "/admin/board/comment/update"
		, data: {
			cNo : c_no,
			bNo : b_no
		}
...
function updateCmtCancel(c_no){
	$.ajax({
		type: "GET"
		, url: "/admin/board/comment/updateCancel"
		, data: {
			cNo: c_no
		}
		, dataType: "HTML"
...
function CmtssInsertFormAfterCmts(c_no){
	...
	$.ajax({
		type: "GET"
		, url: "/admin/board/comments/insert"
		, data: {
			cNo: c_no
			, bNo: ${viewBoard.B_NO}
		}
...
function CmtssInsertFormAfterCmtss(cs_no, c_no, m_nick){
	$.ajax({
		type: "GET"
		, url: "/admin/board/commentss/insert"
		, data: {
			csNo: cs_no
			, cNo: c_no
			, mNick: m_nick
...
function CmtCmtInsertCancel(cs_no, m_nick){
	$.ajax({
		type: "GET"
		, url: "/admin/board/commentss/insertcancel"
		, data: {
			csNo: cs_no
			, mNick: m_nick
			, bNo: ${viewBoard.B_NO }
...
function CmtCmtUpdateForm(cs_no, m_nick, cs_content){
	...
	$("#CmtCmtText").remove();
 	...
 	$.ajax({
 		type: "GET"
 		, url: "/admin/board/commentss/update"
 		, data: {
 			csNo: cs_no
 			, mNick: m_nick
...
function CmtCmtUpdateCancel(){
	$.ajax({
		type: "GET" 
		, url: "/admin/board/commentss/updatecancel"
		, data: {
			bNo: ${viewBoard.B_NO}
		}
		, dataType: "html"
...
function CmtCmtdelete(cs_no, b_no){
	$.ajax({
		type: "GET"
		, url: "/admin/board/commentss/delete"
		, data: {
			csNo: cs_no
			, bNo: b_no
		}
