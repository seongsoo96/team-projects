	    ...
	    <div class="thumbnail">
	      <c:choose>
	      	<c:when test = "${fn:length(info.iStoredName)<20}">
	      		<a href="#"><img src="/resources/img/${info.iStoredName }" style="width:100%; height:250px;"></a>
	      	</c:when>
	      	<c:otherwise>
	      		<a href="#"><img src="/upload/information/${info.iStoredName }" style="width:100%; height:250px;"></a>
	      	</c:otherwise>
	      </c:choose>
	      <div class="caption">
	        <h3>${info.iTitle }</h3>
