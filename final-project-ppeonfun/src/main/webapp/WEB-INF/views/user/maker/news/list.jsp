...
<div class="container">
<h1 class="pull-left">새소식 관리 &nbsp;<a href="/user/maker/news/write?pNo=${project.pNo }"><i class="fas fa-plus"></i></a></h1>
...
<c:forEach items="${list }" var="news">
	<tr>
		<td style="text-align:center;"><a href="/user/maker/news/view?nNo=${news.nNo }">${news.nTitle }</a></td>
		<td style="text-align:center;">${news.nCategory }</td>
		<td style="text-align:center;"><fmt:formatDate value="${news.nOpenDate }" pattern="yy-MM-dd" /></td>
		<td style="text-align:center;"><fmt:formatDate value="${news.nCreateDate }" pattern="yy-MM-dd" /></td>
	</tr>
</c:forEach>
</tbody>
</table>
...
<form action="/user/maker/news/list" method="get">
<div id="search">
