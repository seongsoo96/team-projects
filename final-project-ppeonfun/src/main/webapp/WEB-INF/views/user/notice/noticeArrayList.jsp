...
<div class="write">
	<button id="BtnWrite" class="BtnWrite" onclick="location.href='/user/notice/write'">글쓰기</button>
</div><br> <%-- write end --%>
...
<tr>
	...
	<a class="arrayLink" href="/user/notice/list?curPage=${paging.curPage }&orderby=${orderby }">좋아요▼</a></th>
</tr>
...
<fmt:formatDate value="${n.B_CREATE_DATE }" pattern="yyMMdd" var="brdStr" />
	<tr>
		...
		<a class="titleLink" href="/user/notice/view?bNo=${n.B_NO }">${n.B_TITLE }</a></td>
		<td>${n.M_NICK }</td>
		<td>
...
<c:import url="/WEB-INF/views/user/notice/noticePaging.jsp" />

<form action="/user/notice/list" method="post">
<div id="search">
