package ppeonfun.controller.admin.supporter;
...
import ppeonfun.service.admin.supporter.SupporterService;
import ppeonfun.util.Paging;

@Controller("admin.SupporterController")
@RequestMapping("/admin/supporter")
public class SupporterController {
	...
	public void list(Paging inData, Project project, Model model) {
		logger.info("/admin/list/supporter 실행");
	...
	public void view(Supporter supporter, Model model) {
		logger.info("/admin/view/supporter 실행");
	...
	public String remove(Supporter suppoerter, Model model) {
		logger.info("/admin/remove/supporter 실행");
		...
		return "redirect:/admin/supporter/list?pNo="+suppoerter.getpNo();
	}
