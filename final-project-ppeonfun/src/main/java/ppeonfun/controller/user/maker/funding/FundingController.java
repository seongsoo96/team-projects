package ppeonfun.controller.user.maker.funding;
...
import ppeonfun.service.user.maker.funding.FundingService;
import ppeonfun.service.user.maker.project.ProjectService;

@Controller("user.maker.FundingController")
@RequestMapping("/user/maker/funding")
public class FundingController {
	...
	public void view(Model model, Project project) {
		int sum=0;
		//통계값 가져오기
		logger.info("/user/maker/funding/view 실행");
